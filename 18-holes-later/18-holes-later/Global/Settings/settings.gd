...
@export_range(1, 14) var DISC_SPEED: int = 1
@export_range(1, 7) var DISC_GLIDE: int = 1 
@export_range(-5, 1) var DISC_TURN: int = 1
@export_range(0, 5) var DISC_FADE: int = 0

#@export var DISC_SPEED: int = 1
#@export var DISC_GLIDE: int = 1
#@export var DISC_TURN: int = 1
#@export var DISC_FADE: int = 0
